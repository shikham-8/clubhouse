...
extension studentRegister1_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        #sourceLocation(file: "/Users/samnagesh/Desktop/clubhouse/clubhouse/clubhouse/studentRegister1.swift", line: 97)
            ...
            ZStack(){
                ...
                VStack(spacing: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value", fallback: 60)) {
                    ...
                    GeometryReader { geometry in
                        VStack(){
                            Rectangle().fill(Color.init(red: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].modifier[0].arg[0].value.arg[0].value", fallback: 1), green: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].modifier[0].arg[0].value.arg[1].value", fallback: 0.357), blue: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].modifier[0].arg[0].value.arg[2].value", fallback: 0.227)))
                            .frame(width: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].modifier[1].arg[0].value", fallback: 450), height: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].modifier[1].arg[1].value", fallback: 300))
                            Divider()
                            Divider()
                        ...
                        VStack(){
                            Text(__designTimeString("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[0].value", fallback: "Student Register"))
                               .font(Font.custom(__designTimeString("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[1].arg[0].value.[0].modifier[0].arg[0].value.arg[0].value.[0].value", fallback: "Montserrat-Regular"), size: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[1].arg[0].value.[0].modifier[0].arg[0].value.arg[1].value", fallback: 28)))
                                .fontWeight(.medium)
                               .foregroundColor(Color.white)
                            Image(__designTimeString("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[0].value", fallback: "student1"))
                            .resizable()
                            .aspectRatio(contentMode: .fit)
                            .frame(width: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[1].arg[0].value.[1].modifier[2].arg[0].value", fallback: 50.0), height: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0].arg[0].value.[1].arg[0].value.[1].modifier[2].arg[1].value", fallback: 50.0))
                    ...
                    NavigationLink(destination: studentRegister2()) {
                            Text(__designTimeString("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].arg[1].value.[0].arg[0].value.[0].value", fallback: "next"))
                                .font(Font.custom(__designTimeString("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].arg[1].value.[0].modifier[0].arg[0].value.arg[0].value.[0].value", fallback: "Montserrat-Medium"), size: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].arg[1].value.[0].modifier[0].arg[0].value.arg[1].value", fallback: 24)))
                                .foregroundColor(.white)
                                .padding()
                        }
                        .frame(width: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[0].arg[0].value", fallback: 100), height: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[0].arg[1].value", fallback: 50))
                        .background(Color.init(red: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[1].arg[0].value.arg[0].value", fallback: 1), green: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[1].arg[0].value.arg[1].value", fallback: 0.357), blue: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[1].arg[0].value.arg[2].value", fallback: 0.227)))
                        .border(Color.init(red: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[2].arg[0].value.arg[0].value", fallback: 1), green: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[2].arg[0].value.arg[1].value", fallback: 0.357), blue: __designTimeFloat("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[2].arg[0].value.arg[2].value", fallback: 0.227)))
                        .cornerRadius(__designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[3].arg[0].value", fallback: 10))
                        .padding(__designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[4].arg[0].value", fallback: 50))
                        .shadow(color: Color.gray, radius: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[5].arg[1].value", fallback: 3), x: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[5].arg[2].value", fallback: -2), y: __designTimeInteger("#24099.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[1].value.[5].modifier[5].arg[3].value", fallback: 5))
                }
            }
        })
#sourceLocation()
