...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="clubhouse",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9clubhouse11AppDelegate")
...
SWIFT_CLASS("_TtC9clubhouse11Coordinator")
@interface Coordinator : NSObject <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC9clubhouse13SceneDelegate")
