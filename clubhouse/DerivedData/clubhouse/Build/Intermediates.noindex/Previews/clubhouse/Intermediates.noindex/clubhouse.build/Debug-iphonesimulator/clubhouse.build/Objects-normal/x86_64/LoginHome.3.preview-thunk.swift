        ...
        AnyView(__designTimeSelection(ZStack {
            ...
            __designTimeSelection(VStack (spacing: __designTimeInteger("#25276.[1].[0].property.[0].[0].arg[0].value.[1].arg[0].value", fallback: 200)){
                ...
                __designTimeSelection(VStack {
                    ...
                    .background(__designTimeSelection(Color.CustomPurple, "#25276.[1].[0].property.[0].[0].arg[0].value.[1].arg[1].value.[1].arg[0].value.[0].modifier[1].arg[0].value"))
                    ...
                    __designTimeSelection(Button(action: /*@START_MENU_TOKEN@*/{}/*@END_MENU_TOKEN@*/) {
                        __designTimeSelection(Text(__designTimeString("#25276.[1].[0].property.[0].[0].arg[0].value.[1].arg[1].value.[1].arg[0].value.[2].arg[1].value.[0].arg[0].value.[0].value", fallback: "Login"))
                            ...
                            .foregroundColor(__designTimeSelection(Color.CustomPurple, "#25276.[1].[0].property.[0].[0].arg[0].value.[1].arg[1].value.[1].arg[0].value.[2].arg[1].value.[0].modifier[1].arg[0].value"))
                    ...
                    .border(__designTimeSelection(Color.CustomPurple, "#25276.[1].[0].property.[0].[0].arg[0].value.[1].arg[1].value.[1].arg[0].value.[2].modifier[2].arg[0].value"))
